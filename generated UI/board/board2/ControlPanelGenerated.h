...
#define CONTROLPANELAPPOBJECTS     {  FurnitureHttpControlObjectPath, HttpControlInterfaces  }, \
    ...
    {  enFurnitureLightObjectPath, PropertyInterfaces  }, \
...
#define NUM_CONTROLPANEL_OBJECTS 5
...
#define EN_FURNITURE_LIGHT_GET_VALUE                  AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET)
#define EN_FURNITURE_LIGHT_SET_VALUE                  AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_SET)
#define EN_FURNITURE_LIGHT_GET_ALL_VALUES             AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET_ALL)
#define EN_FURNITURE_LIGHT_VERSION_PROPERTY           AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 0)
#define EN_FURNITURE_LIGHT_STATES_PROPERTY            AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 1)
#define EN_FURNITURE_LIGHT_OPTPARAMS_PROPERTY         AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 2)
#define EN_FURNITURE_LIGHT_SIGNAL_PROPERTIES_CHANGED  AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 1, 3)
#define EN_FURNITURE_LIGHT_VALUE_PROPERTY             AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 4)
#define EN_FURNITURE_LIGHT_SIGNAL_VALUE_CHANGED       AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 1, 5)

#define EN_FURNITURE_ELECTRIC_FAN_GET_VALUE                  AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET)
#define EN_FURNITURE_ELECTRIC_FAN_SET_VALUE                  AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_SET)
#define EN_FURNITURE_ELECTRIC_FAN_GET_ALL_VALUES             AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET_ALL)
#define EN_FURNITURE_ELECTRIC_FAN_VERSION_PROPERTY           AJ_APP_PROPERTY_ID(4 + NUM_PRECEDING_OBJECTS, 1, 0)
#define EN_FURNITURE_ELECTRIC_FAN_STATES_PROPERTY            AJ_APP_PROPERTY_ID(4 + NUM_PRECEDING_OBJECTS, 1, 1)
#define EN_FURNITURE_ELECTRIC_FAN_OPTPARAMS_PROPERTY         AJ_APP_PROPERTY_ID(4 + NUM_PRECEDING_OBJECTS, 1, 2)
#define EN_FURNITURE_ELECTRIC_FAN_SIGNAL_PROPERTIES_CHANGED  AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 1, 3)
#define EN_FURNITURE_ELECTRIC_FAN_VALUE_PROPERTY             AJ_APP_PROPERTY_ID(4 + NUM_PRECEDING_OBJECTS, 1, 4)
#define EN_FURNITURE_ELECTRIC_FAN_SIGNAL_VALUE_CHANGED       AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 1, 5)
...
extern PropertyWidget FurnitureLight;
