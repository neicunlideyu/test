...
case EN_FURNITURE_LIGHT_GET_VALUE: \
...
case EN_FURNITURE_LIGHT_SET_VALUE: \
case EN_FURNITURE_LIGHTCONFIRM_SET_VALUE: \


#define ACTION_CASES \
case EN_FURNITURE_LIGHT_EXEC: \
...
#define CONTROLPANELAPPOBJECTS     {  FurnitureHttpControlObjectPath, HttpControlInterfaces  }, \
    ...
    {  enFurnitureLampObjectPath, PropertyInterfaces  }, \
    {  enFurnitureLightObjectPath, ActionInterfaces  }, \
...
#define EN_FURNITURE_LAMP_GET_VALUE                  AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET)
#define EN_FURNITURE_LAMP_SET_VALUE                  AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_SET)
#define EN_FURNITURE_LAMP_GET_ALL_VALUES             AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET_ALL)
#define EN_FURNITURE_LAMP_VERSION_PROPERTY           AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 0)
#define EN_FURNITURE_LAMP_STATES_PROPERTY            AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 1)
#define EN_FURNITURE_LAMP_OPTPARAMS_PROPERTY         AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 2)
#define EN_FURNITURE_LAMP_SIGNAL_PROPERTIES_CHANGED  AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 1, 3)
#define EN_FURNITURE_LAMP_VALUE_PROPERTY             AJ_APP_PROPERTY_ID(3 + NUM_PRECEDING_OBJECTS, 1, 4)
#define EN_FURNITURE_LAMP_SIGNAL_VALUE_CHANGED       AJ_APP_MESSAGE_ID(3 + NUM_PRECEDING_OBJECTS, 1, 5)

#define EN_FURNITURE_LIGHT_GET_VALUE                  AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET)
#define EN_FURNITURE_LIGHT_SET_VALUE                  AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_SET)
#define EN_FURNITURE_LIGHT_GET_ALL_VALUES             AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET_ALL)
#define EN_FURNITURE_LIGHT_VERSION_PROPERTY           AJ_APP_PROPERTY_ID(4 + NUM_PRECEDING_OBJECTS, 1, 0)
#define EN_FURNITURE_LIGHT_STATES_PROPERTY            AJ_APP_PROPERTY_ID(4 + NUM_PRECEDING_OBJECTS, 1, 1)
#define EN_FURNITURE_LIGHT_OPTPARAMS_PROPERTY         AJ_APP_PROPERTY_ID(4 + NUM_PRECEDING_OBJECTS, 1, 2)
#define EN_FURNITURE_LIGHT_SIGNAL_PROPERTIES_CHANGED  AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 1, 3)
#define EN_FURNITURE_LIGHT_EXEC                       AJ_APP_MESSAGE_ID(4 + NUM_PRECEDING_OBJECTS, 1, 4)

#define EN_FURNITURE_LIGHTCONFIRM_GET_VALUE                  AJ_APP_MESSAGE_ID(5 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET)
#define EN_FURNITURE_LIGHTCONFIRM_SET_VALUE                  AJ_APP_MESSAGE_ID(5 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_SET)
#define EN_FURNITURE_LIGHTCONFIRM_GET_ALL_VALUES             AJ_APP_MESSAGE_ID(5 + NUM_PRECEDING_OBJECTS, 0, AJ_PROP_GET_ALL)
#define EN_FURNITURE_LIGHTCONFIRM_VERSION_PROPERTY           AJ_APP_PROPERTY_ID(5 + NUM_PRECEDING_OBJECTS, 1, 0)
#define EN_FURNITURE_LIGHTCONFIRM_STATES_PROPERTY            AJ_APP_PROPERTY_ID(5 + NUM_PRECEDING_OBJECTS, 1, 1)
#define EN_FURNITURE_LIGHTCONFIRM_OPTPARAMS_PROPERTY         AJ_APP_PROPERTY_ID(5 + NUM_PRECEDING_OBJECTS, 1, 2)
#define EN_FURNITURE_LIGHTCONFIRM_SIGNAL_PROPERTIES_CHANGED  AJ_APP_MESSAGE_ID(5 + NUM_PRECEDING_OBJECTS, 1, 3)
#define EN_FURNITURE_LIGHTCONFIRM_MESSAGE_PROPERTY           AJ_APP_PROPERTY_ID(5 + NUM_PRECEDING_OBJECTS, 1, 4)
#define EN_FURNITURE_LIGHTCONFIRM_NUM_ACTIONS_PROPERTY       AJ_APP_PROPERTY_ID(5 + NUM_PRECEDING_OBJECTS, 1, 5)
#define EN_FURNITURE_LIGHTCONFIRM_EXEC_ACTION1               AJ_APP_MESSAGE_ID(5 + NUM_PRECEDING_OBJECTS, 1, 6)
#define EN_FURNITURE_LIGHTCONFIRM_EXEC_ACTION2               AJ_APP_MESSAGE_ID(5 + NUM_PRECEDING_OBJECTS, 1, 7)
#define EN_FURNITURE_LIGHTCONFIRM_EXEC_ACTION3               AJ_APP_MESSAGE_ID(5 + NUM_PRECEDING_OBJECTS, 1, 8)
...
extern const char enFurnitureLightObjectPath[];
extern const char enFurnitureLightConfirmObjectPath[];


extern ContainerWidget FurnitureFurnitureController;
extern PropertyWidget FurnitureLamp;
extern ActionWidget FurnitureLight;
